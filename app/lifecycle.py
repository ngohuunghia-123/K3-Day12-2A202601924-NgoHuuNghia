...
class Lifecycle:
    ...
    def request_shutdown(self, signum=None, frame=None) -> None:
        ...
        Chữ ký (signum, frame) bắt buộc vì Python gọi handler với 2 tham số.
        Không làm gì nặng ở đây — handler chạy xen giữa bytecode.
        """
        self.shutting_down = True
        # Gọi lại handler cũ (của uvicorn) để server thực sự dừng
        # Nếu không: app bật cờ "đang tắt" rồi chạy tiếp mãi mãi
